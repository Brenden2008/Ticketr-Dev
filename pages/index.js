...
export default function Home() {
  return (
    <div>
      <body class="bg-dark">
        <div class="container">
          <section class="bg-dark pb-5 pt-5 text-center">
            <div class="container pb-5 pt-5">
              <div class="pb-5 pt-5 row">
                <div class="col-lg-9 col-xl-8 ms-auto me-auto pb-5 pt-5">
                  ...
                  <p class="fw-light lead mb-4 text-white">
                    Ticketr is a free, open source booking and registration for
                    events of all sizes.
                  </p>{' '}
                  <a href="#" class="btn btn-primary pe-3 ps-3">
                    Get It Now
                  </a>
                </div>
              </div>
              <section class="pb-5 pt-5">
                <div class="bg-dark pb-5 pt-5">
                  <div class="align-items-center mb-3 row">
                    <div class="col-lg-12">
                      <h2 class="h6 mb-1 text-white" id="features">
                        &nbsp;Features
                      </h2>
                      <h3 class="fw-bold h2 mb-1 text-white">
                    ...
                    <div class="col-lg-auto ms-auto"></div>
                  </div>
                  <div class="row">
                    ...
                    <div class="col-sm-6 col-xl-3 pb-3 pt-3">
                      <div class="btn-secondary mb-sm-n5 mt-sm-5 pb-5 ps-4 pe-4 pt-5 shadow">
                        <h4 class="fw-bold h5">Booking Process</h4>
                        <p>
                    ...
                    <div class="col-sm-6 col-xl-3 pb-3 pt-3">
                      <div class="btn-secondary pb-5 ps-4 pe-4 pt-5 shadow">
                        <h4 class="fw-bold h5">Calenders</h4>
                        <p>
                  ...
                  <section class="pb-5 pt-5" id="abouttheteam">
                    <div class="container">
                      <div class="justify-content-center row">
                        <div class="col-lg-4 col-md-6 py-3">
                          <div class="bg-primary p-3">
                            ...
                            />
                            <div>
                              <h3 class="fw-bold h4 mb-1">Brenden Stahle</h3>
                              <h4 class="fw-light h6 mb-3">
                                Back-end Developer
                              </h4>
                        ...
                        <div class="col-lg-4 col-md-6 py-3">
                          <div class="bg-primary p-3">
                            ...
                            />
                            <div>
                              <h3 class="fw-bold h4 mb-1">Max Olcott</h3>
                              <h4 class="fw-light h6 mb-3">UI Developer</h4>
                              <div class="d-inline-flex flex-wrap">
                                <a
                        ...
                        <div class="col-lg-4 col-md-6 py-3">
                          <div class="bg-primary p-3">
                            ...
                            />
                            <div>
                              <h3 class="fw-bold h4 mb-1">Ashton Vinson</h3>
                              <h4 class="fw-light h6 mb-3">Quality Control</h4>
                              <div class="d-inline-flex flex-wrap">
                                {' '}
                                <u>Github-None</u>
                                <a
                    ...
                    <h6 class="text-white">About The Team</h6>
              ...
              <h2 class="text-center text-primary" id="about">
                About Ticketr
              </h2>
              <p class="text-white">
                ...
                <div class="container pb-4 pt-4">
                  <div class="align-items-center row">
                    <div class="col-lg-12 py-3">
                      <h2
                        class="fw-bold h4 mb-4 text-uppercase text-white"
                        id="contactus"
                      >
                        Contact Us
                      </h2>
                      ...
                      <div class="mb-4 g-0 row">
                        ...
                        <div class="col">
                          {' '}
                          <a href="mailto:info@ticketr.xyz" class="text-white">
                            hello@ticketr.xyz
                          </a>{' '}
                          <br />{' '}
                          <a href="mailto:help@ticketr.xyz" class="text-white">
                            help@ticketr.xyz
                          </a>
                        </div>
                      </div>
                      <div class="mb-4 g-0 row">
                        ...
                        <div class="col">
                          {' '}
                          <a href="tel:+0 123-456-789" class="text-white">
                            +1 (918) 419-1313
                          </a>
                        </div>
                      </div>
          ...
          <footer class="pb-3 pt-3 small text-primary">
            <div class="container">
              <div class="align-items-center row">
                <div class="col-md pb-2 pt-2">
                  <p class="mb-0">&copy; 2022. All Rights Reserved - Ticketr</p>
                </div>
                <div class="col-md-auto pb-2 pt-2 text-pri text-primary">
                  {' '}
